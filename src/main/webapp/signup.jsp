		...
		<div class="content-main">
			...
			<div class="signin-box">
				...
				<div class="signin-input">
					...
					<div class="input-box">
						<div class="input-item">
							<form action="signup_id_proc.jsp">
								<input class="input-id" type="text" placeholder="최대 10글자"
									name="id">
						</div>
						<div>

							<button type="submit" class="id-chd">확인</button>
							</button>
							</form>
						</div>
					</div>
				...
				<div class="signin-input">
					...
					<div class="input-box">
						<div>
							<form action="signup_pw_proc.jsp">
				...
				<div class="signin-input signin-input-id">
					<div class="input-box">
						...
						<div>
							<button type="button" class="id-chd" id="chkBtn">확인</button>
						</div>
					</div>
				</div>
				<!-- 이름-->
				...
				<div class="signin-input signin-input-id">
					...
					<div class="signin-birth">
						<input class="birth-box" name="birth-year" id="birth-year"
							type="text" placeholder="출생년도"> <select class="birth-box"
							name="birth-month" id="birth-month">
					...
					<div class="signin-input signin-input-id">
						...
						<div class="signin-id signin-gender">
							<div>
								<input class="input-gender" type="radio" name="gender" value="F">남성
							</div>
							<div>
								<input class="input-gender" type="radio" name="gender" value="M">여성
							</div>
						</div>
					</div>
					<!-- 운전면허번호 -->
