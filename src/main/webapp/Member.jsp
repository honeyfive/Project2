...
<body>
  ...
  <path
	...
	<table class="member_graph">
		...
		<tr>
			<td><%=memberInfo.getMembership_number()%><a
				href="./Member.jsp?id=<%=memberInfo.getMembership_number()%>"></a></td>
			...
			<td><%=memberInfo.getMembership_level()%><a
				href="./Member.jsp?id=<%=memberInfo.getMembership_level()%>"></a></td>
